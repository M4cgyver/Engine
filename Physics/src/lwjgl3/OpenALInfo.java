...
import org.lwjglx.openal.EFXUtil;
...
public class OpenALInfo {
	...
	public static void printALCInfo(long device, ALCCapabilities caps) {
	...
	public static void printALInfo() {
	...
	public static void printEFXInfo(long device) {
	...
	public static void printDevices(int which, String kind) {
