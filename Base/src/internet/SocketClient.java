...
/* Note: This is to make the use of Sockets easier with lamda functions and shortand code
/*==============================================================================================*/

public class SocketClient {
	public static interface SocketClientInterface { void recieve(Object o); void disconnect();}		//Setup the interface to call the funciton
        ...
        Runnable rListener = () ->												//Create a runnable class to get input
		{
			...
			{ 
				try {
					...
					sci.recieve(message);										//Pass the message 
